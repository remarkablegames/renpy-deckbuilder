...
- [Linux](https://github.com/remarkablegames/renpy-deckbuilder/releases/latest/download/linux.tar.bz2)
...
- `game_menu_action` set to "preferences"

`game/screens.rpy`:

- "Save" and "Load" are commented out
- `quick_menu` is disabled
